...
const FilterSidebar = () => {
  ...
  return (
    <div className="space-y-6 text-sm">
      ...
      {/* CATEGORY DROPDOWN */}
      <div>
        <button type="button" onClick={() => setOpenCategory(!openCategory)}
          className="w-full flex justify-between items-center font-semibold tracking-wider md:tracking-normal mb-3">
          SHOP BY CATEGORY
          <PiCaretDownBold className={`transition-transform duration-300 ${openCategory ? "rotate-180" : ""}`} size={18} />
        </button>

        {openCategory && (
          <div className="space-y-2">
            {["Kurta Set", "Sharara Set", "Lehenga Set", "Blouse", "Coord Set",
              "Saree",
            ].map((item) => (
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-3 ">
              <input
                ...
                className="w-24 md:w-16 border  py-1  rounded text-sm"
              />
              <span>-</span>
              <input
                type="number"
