const NewsletterSection = () => {
    return (
        <section className="py-12 bg-[#faf5f7] relative">

            <div className="max-w-6xl mx-auto px-6 text-center text-white">

                <h2 className="font-heading text-3xl md:text-4xl mb-4 text-[#8b1c62]">
                ...
                <form onSubmit={(e) => {
                    ...
                    <button type="submit" className="bg-[#8b1c62] px-4 py-2 md:px-8 md:py-4 rounded-full font-semibold hover:bg-[#a8326d] 
