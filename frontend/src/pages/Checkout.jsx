    ...
    if (checkoutItems.length === 0) {
        return (
            <div className="pt-20 pb-10 text-center">
                ...
                <Link
                    to="/shop"
                    className="inline-block mt-4 w-64 bg-[#8b1c62] text-white py-3 rounded-lg font-semibold"
                >
                    Continue Shopping
                </Link>
            </div>
        ...
        <>
            ...
            <div className="pt-5 px-3 max-w-6xl mx-auto grid md:grid-cols-3 gap-8 mb-20">
                ...
                <div className="border rounded-lg p-6 h-fit">
                    ...
                    <button
                        ...
                        className="mt-6 w-full bg-[#8b1c62] text-white py-3 rounded-lg font-semibold"
                    >
                        Place Order
                    </button>
                </div>
            ...
            {/* {showModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white w-4/6 max-w-2xl rounded-xl shadow-lg">
                        ...
                        <div className="flex justify-end gap-4 p-5 border-t">
                            ...
                            <button
                                ...
                                className="px-6 py-2 bg-[#8b1c62] text-white rounded-lg font-semibold hover:bg-[#6d1550]"
                            >
                                Save & Use
                            </button>
                    ...
                    <div className="bg-white p-5 w-4/6 max-w-2xl rounded-xl shadow-lg">
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <button
                                ...
                                className="px-6 py-2 bg-[#8b1c62] text-white rounded-lg"
                            >
                                Save & Place Order
                            </button>
                        </div>
