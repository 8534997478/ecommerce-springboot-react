...
const WhyChooseVastraa = () => {
    return (
        <section className="py-14 bg-[#fff6f2]">
            <div className="max-w-7xl mx-auto px-6 md:px-14">

                {/* Section Header */}
                <div className="text-center mb-14">
                    <h2 className="font-heading text-3xl md:text-4xl text-[#8b1c62] mb-3">
                        Why Choose VASTRAA
                    </h2>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    {whyChooseData.map((item, index) => (
                        ...
                        hover:-translate-y-1 transition duration-300">
                            <div className=" flex justify-center text-4xl text-[#8b1c62] mb-2 ">
                                {iconMap[item.icon]}
                            </div>

                            <h3 className="font-heading text-lg text-[#8b1c62] mb-2">
                                {item.title}
                            </h3>
