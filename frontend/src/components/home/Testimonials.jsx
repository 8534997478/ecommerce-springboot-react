...
const Testimonials = () => {
    return (
        <section className="py-10 md:py-12 bg-[#8a1652] border-t border-[#8b1c62]/10">
            <div className="max-w-7xl mx-auto px-6 md:px-14">
                ...
                <div className="text-center mb-14">
                    ...
                    <p className="text-gray-200 max-w-2xl mx-auto">
                        Real stories from women who chose VASTRAA for their ethnic elegance.
                    </p>
                </div>
                    ...
                    {testimonialsData.map((item, index) => (
                        ...
                        transition duration-300 relative">
                            ...
                            <div className="text-center">
                                <h4 className="font-semibold text-[#8b1c62]">
                                    {item.name}
                                </h4>
